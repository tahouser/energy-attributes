...
if (!customElements.get(TAG)) {
  class EnergyIQCard extends HTMLElement {
    constructor() { super(); this._hass=null; this._cfg={}; this._data=null; this._entryId=null; this._view=0; this._timer=null; this._busy=false; this._click=this._handleClick.bind(this); }
    ...
    getGridOptions(){return {rows:4,columns:6,min_rows:3,max_rows:8,min_columns:3,max_columns:12};}
    ...
    _css(){return ':host{display:block;width:100%;min-width:0;max-width:100%;height:100%;box-sizing:border-box}.pad{padding:15px 16px 10px;color:var(--primary-text-color);min-width:0;width:100%;box-sizing:border-box;overflow:hidden}ha-card{display:flex;flex-direction:column;width:100%;height:100%;max-width:100%;box-sizing:border-box}.head{display:flex;justify-content:space-between;align-items:flex-start;gap:10px}.card-title-wrap{display:flex;align-items:center;gap:9px;min-width:0}.card-icon{width:34px;height:34px;flex:none;display:grid;place-items:center;border-radius:10px;background:rgba(28,205,255,.12);border:1px solid rgba(28,205,255,.28);color:#36c8ff;font-size:20px;font-weight:800}.head-actions{display:flex;align-items:center;gap:6px;flex:none}.eyebrow{font-size:.72rem;letter-spacing:.12em;font-weight:700;color:var(--secondary-text-color)}.title{font-size:1.2rem;font-weight:700}.sub{font-size:.78rem;color:var(--secondary-text-color)}.head-actions button{width:36px;height:36px;padding:0}.active-shortcut{background:rgba(20,242,184,.14);color:#35e7b0;border:1px solid rgba(20,242,184,.35)}.open-shortcut{background:rgba(28,205,255,.12);color:#36c8ff;border:1px solid rgba(28,205,255,.28)}button{width:40px;height:40px;border:0;border-radius:50%;background:var(--primary-color,#03a9f4);color:#fff;font-size:1.5rem;cursor:pointer}.body{min-height:190px;flex:1;display:flex;align-items:center;min-width:0;width:100%;overflow:hidden}.dots{display:flex;justify-content:center;gap:6px}.dots i{width:6px;height:6px;border-radius:50%;background:var(--divider-color)}.dots i.on{background:var(--primary-color)}.chart{width:100%;min-width:0;overflow:hidden}.summary{display:flex;gap:7px;align-items:baseline;margin:4px}.summary b,.big{font-size:2.1rem}.summary span,.sub{color:var(--secondary-text-color);font-size:.76rem}svg{display:block;width:100%;max-width:100%;height:175px;overflow:hidden}.axis{stroke:var(--divider-color)}.line{fill:none;stroke:var(--primary-color);stroke-width:3;stroke-linecap:round}.dotline{fill:var(--primary-color);stroke:var(--ha-card-background,#1c1c1c);stroke-width:2}.v{fill:var(--primary-text-color);font-size:11px;font-weight:700}.x{fill:var(--secondary-text-color);font-size:11px}.c0{fill:#2196f3}.c1{fill:#42a5f5}.c2{fill:#26a69a}.c3{fill:#ffb300}.c4{fill:#ef5350}.myst,.cost{width:100%;padding:8px 4px}.big{font-weight:700;line-height:1}.big span{font-size:1rem;color:var(--secondary-text-color)}.status{display:flex;justify-content:space-between;margin-top:8px;font-size:.8rem;color:var(--secondary-text-color)}.stack{display:flex;height:32px;border-radius:9px;overflow:hidden;background:var(--divider-color);margin-top:9px}.known{background:#42a5f5}.unknown{background:#ef5350}.legend{display:flex;justify-content:space-between;gap:10px;flex-wrap:wrap;margin-top:10px;font-size:.78rem}.legend span{display:flex;align-items:center;gap:6px}.legend i{width:9px;height:9px;border-radius:50%}.kd{background:#42a5f5}.ud{background:#ef5350}.total{display:flex;justify-content:space-between;border-top:1px solid var(--divider-color);padding-top:9px;margin-top:12px;font-size:.8rem;color:var(--secondary-text-color)}.total b{color:var(--primary-text-color)}.track{height:31px;border-radius:9px;overflow:hidden;margin-top:20px;background:linear-gradient(90deg,#43a047,#fdd835 45%,#fb8c00 70%,#e53935)}.mask{height:100%;background:rgba(20,20,20,.58);margin-left:auto}.scale{display:flex;justify-content:space-between;color:var(--secondary-text-color);font-size:.7rem;margin-top:4px}.break{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:15px}.break div{display:flex;justify-content:space-between;border-top:1px solid var(--divider-color);padding-top:8px;font-size:.82rem}.break span{color:var(--secondary-text-color)}.empty{width:100%;text-align:center;color:var(--secondary-text-color);font-size:.9rem}.err{margin-top:10px;color:var(--error-color)}.active-loads-backdrop{position:fixed;inset:0;z-index:10000;background:rgba(0,0,0,.58);display:flex;align-items:center;justify-content:center;padding:16px}.active-loads{width:min(430px,100%);max-height:82vh;overflow:auto;background:var(--card-background-color);border:1px solid var(--divider-color);border-radius:14px;box-shadow:var(--ha-card-box-shadow);padding:16px;box-sizing:border-box}.active-loads-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.active-loads-title{font-size:1.25rem;font-weight:800}.active-loads-head button{width:38px;height:38px;padding:0}.active-load-list{margin-top:12px}.active-load-row{display:flex;justify-content:space-between;gap:12px;padding:9px 2px;border-bottom:1px solid var(--divider-color)}.active-load-row span{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.active-load-row strong{white-space:nowrap;font-variant-numeric:tabular-nums}.active-load-empty{text-align:center;padding:22px;color:var(--secondary-text-color)}.active-load-summary{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;margin-top:12px}.active-load-summary div{padding:9px;border-radius:9px;background:var(--secondary-background-color);border:1px solid var(--divider-color)}.active-load-summary span{display:block;font-size:9px;text-transform:uppercase;color:var(--secondary-text-color)}.active-load-summary strong{display:block;margin-top:3px;font-size:14px;font-variant-numeric:tabular-nums}@media(max-width:500px){.pad{padding:12px}.head{gap:7px}.card-title-wrap{gap:7px}.card-icon{width:30px;height:30px;border-radius:8px;font-size:18px}.head-actions{gap:4px}.head-actions button{width:32px;height:32px;font-size:1.15rem}.title{font-size:1.05rem}.active-loads-backdrop{padding:10px}.active-loads{max-height:88vh;padding:14px}.active-load-summary{grid-template-columns:1fr 1fr}.active-load-summary div:last-child{grid-column:1/-1}.body{min-height:185px}svg{height:165px}.x,.v{font-size:10px}}';}
  }
