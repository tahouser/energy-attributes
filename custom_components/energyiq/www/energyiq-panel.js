...
(() => {
  ...
  class EnergyIQPanel extends HTMLElement {
    constructor() {
      ...
      this.workspace = null;
      this.bulk = null;
      this.brandUrl = "/energyiq-brand/icon.png?v=31420";
      this.view = "all";
    ...
    loadUpperSectionsCollapsed() {
      try { return localStorage.getItem("energyiq.upper_sections_collapsed") === "true"; }
      catch (error) { return false; }
    }
    toggleUpperSections() {
      this.upperSectionsCollapsed = !this.upperSectionsCollapsed;
      try { localStorage.setItem("energyiq.upper_sections_collapsed", String(this.upperSectionsCollapsed)); }
      catch (error) { /* localStorage may be unavailable in restricted browsers */ }
      this.render();
    }
