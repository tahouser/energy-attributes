...
hasPendingChanges() {
    ...
    showEntityHistory(deviceId) {
      ...
      if (!root) {
        this.showToast("Home Assistant interface is not ready.", true);
        return;
      }
      const event = new Event("hass-more-info", { bubbles: true, composed: true });
      event.detail = { entityId, view: "info" };
