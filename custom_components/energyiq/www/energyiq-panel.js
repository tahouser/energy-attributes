 ...
 */
(() => {
  const TAG = "energyiq-panel-v330";
  const VERSION = "31399";
  const UI_VERSION = "3.1.118";
  ...
  class EnergyIQPanel extends HTMLElement {
    constructor() {
      ...
      this.workspace = null;
      this.bulk = null;
      this.brandUrl = "/energyiq-brand/icon.png?v=31399";
      this.view = "all";
