 ...
 */
(() => {
  const TAG = "energyiq-panel-v333";
  const VERSION = "31402";
  const UI_VERSION = "3.1.121";
  ...
  class EnergyIQPanel extends HTMLElement {
    constructor() {
      ...
      this.workspace = null;
      this.bulk = null;
      this.brandUrl = "/energyiq-brand/icon.png?v=31402";
      this.view = "all";
    ...
    styles() { return `
      ...
      .brand-logo{width:60px;height:60px;flex:none;display:block;object-fit:contain}.brand-copy{min-width:0}.brand-name-row{display:flex;align-items:baseline;gap:18px;flex-wrap:wrap}.tagline{font-size:20px;font-weight:600;font-style:italic;color:#36c8ff;white-space:nowrap;border-left:1px solid rgba(54,200,255,.55);padding-left:18px}h1{margin:0 0 4px;font-size:31px;letter-spacing:.01em}p{margin:0;color:var(--secondary-text-color)}
      ...
      @media(max-width:1100px){.summary{grid-template-columns:repeat(3,1fr)}.meter-grid{grid-template-columns:repeat(2,1fr)}.table-scroll{max-height:none}.queue-strip{grid-template-columns:repeat(3,1fr)}.queue-more{grid-column:1/-1}.training-grid{grid-template-columns:1fr}}@media(max-width:700px){.title-row{display:flex;align-items:center;gap:9px;padding:0 2px}.back-button{flex:none;align-self:center;width:54px;height:54px}.brand-logo{width:42px;height:42px;flex:none}.brand-copy{min-width:0;flex:1}.brand-name-row{gap:6px;flex-wrap:wrap;align-items:baseline}.brand-name-row h1{font-size:clamp(2rem,9vw,2.55rem);line-height:1}.tagline{font-size:clamp(13px,4vw,17px);white-space:nowrap}.brand-copy p{font-size:13px;line-height:1.2;margin-top:5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.meter-grid{grid-template-columns:1fr}.section-heading{align-items:flex-start;flex-direction:column}.shell{padding:0 12px 16px}header{margin:0 -12px 12px;padding:15px 14px}.title-row{gap:10px}.back-button{width:34px;height:34px;font-size:20px}.brand-logo{width:46px;height:46px}.brand-name-row{gap:9px}.tagline{font-size:16px;padding-left:9px}h1{font-size:25px}.summary{grid-template-columns:repeat(2,1fr);gap:7px}.metric{padding:10px}.metric strong{font-size:17px}.toolbar{align-items:stretch}.views,.toolbar-actions{width:100%}.views button,.toolbar-actions button{flex:1}.list-tools{align-items:stretch}.search-box{max-width:none}.result-count{display:none}.selection-bar{align-items:stretch}.selection-actions{width:100%}.selection-actions button{flex:1}.table-scroll{max-height:none}.queue-strip{grid-template-columns:1fr}.training-workspace{padding:12px}.capture-grid{grid-template-columns:repeat(2,1fr)}.training-head{align-items:center}.training-head h2{font-size:20px}.modal-actions{grid-template-columns:1fr 1fr}.modal-actions span{display:none}}
    `; }
  }
