...
(() => {
  ...
  class EnergyIQPanel extends HTMLElement {
    constructor() {
      ...
      this.workspace = null;
      this.bulk = null;
      this.brandUrl = "/energyiq-brand/icon.png?v=31393";
      this.view = "all";
