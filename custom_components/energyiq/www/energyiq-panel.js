 ...
 */
(() => {
  const TAG = "energyiq-panel-v331";
  const VERSION = "31400";
  const UI_VERSION = "3.1.119";
  ...
  class EnergyIQPanel extends HTMLElement {
    constructor() {
      ...
      this.workspace = null;
      this.bulk = null;
      this.brandUrl = "/energyiq-brand/icon.png?v=31400";
      this.view = "all";
