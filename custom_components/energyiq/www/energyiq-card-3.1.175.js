/* EnergyIQ dashboard card — 3.1.175 */
  ...
  class EnergyIQCard extends HTMLElement {
    ...
    async _loadCostHistory(){
      ...
      try{
        ...
        this._costTimeline=this._timelineFromStatistics(rows);
    ...
    _brandIconUrl(){const base="/api/brands/integration/energyiq/icon.png";return this._brandToken?base+"?token="+encodeURIComponent(this._brandToken)+"&v=31448":base+"?placeholder=no&v=31448";}
