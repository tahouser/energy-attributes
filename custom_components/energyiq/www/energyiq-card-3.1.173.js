/* EnergyIQ dashboard card — 3.1.173 */
...
if (!customElements.get(TAG)) {
  class EnergyIQCard extends HTMLElement {
    ...
    _brandIconUrl(){const base="/api/brands/integration/energyiq/icon.png";return this._brandToken?base+"?token="+encodeURIComponent(this._brandToken)+"&v=31446":base+"?v=31446";}
