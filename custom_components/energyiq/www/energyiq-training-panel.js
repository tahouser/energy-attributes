...
(() => {
  const TAG = "energyiq-panel-training-v176";
  const BASE_TAG = "energyiq-panel-v325";
  const BASE_URL = "/energyiq-static/energyiq-panel.js?v=31760";
  const define = () => {
